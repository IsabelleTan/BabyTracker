...
import { Milk, Droplets, TriangleAlert, type LucideIcon } from 'lucide-react'
...
const EVENT_LABEL: Record<string, string> = { feed: 'Feed', output: 'Output' }
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      {events.length === 0 ? (
        ...
        <div className="relative select-none" style={{ height: TOTAL_H + 20 }}>
          ...
          <div
            className="absolute"
            style={{
              left: LINE_X, width: LINE_W, top: 0, height: TOTAL_H,
